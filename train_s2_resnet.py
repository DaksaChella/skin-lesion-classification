...
def build_resnet_s2():
    ...
    print("ResNet18 S2 - Full Freeze: only final layer trainable")
    return model

model = build_resnet_s2()
...
print(f"\nTraining ResNet18 S2 for {NUM_EPOCHS} epochs...")
print("=" * 60)
...
torch.save(model.state_dict(), 'saved_models/resnet18_s2.pth')
torch.save(history, 'saved_models/resnet18_s2_history.pth')
print(" Model saved to saved_models/resnet18_s2.pth")